...
namespace App\Extensions\Queue\Jobs;
...
class RabbitmqJob extends Job implements JobContract
{
     ...
     * @param string $queue
     */
    public function __construct(Container $container, RabbitmqQueue $rabbitmqQueue, $job, $reserved, $connectionName, $queue)
    {
    ...
    public function delete()
    {
        ...
        $this->rabbitmqQueue->deleteReserved($this->queue, $this);
    }
    ...
    public function release($delay = 0)
    {
        ...
        $this->rabbitmqQueue->deleteAndRelease($this->queue, $this, $delay);
    }
